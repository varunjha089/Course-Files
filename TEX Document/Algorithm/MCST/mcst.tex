...
\usepackage{lmodern} % Modern font family with full shape support
...
\usepackage{amsmath} % for math fonts like O()

\usepackage{booktabs}
\usepackage{multirow}

\usepackage{array}
\usepackage{caption} % for table caption outside center

\newcolumntype{Y}{>{\raggedright\arraybackslash}X}

% Optional (nicer spacing between rows)
...
\renewcommand{\lstlistlistingname}{Python \& C++ Programs}
...
% \begin{tcolorbox}[title=Where Prim's Algorithm is Not Applicable, colback=white, colframe=red!75!black]
...
% \begin{tcolorbox}[title=Correct Use Case for Prim's Algorithm, colback=white, colframe=green!60!black]
...
\hline
\end{tabular}
% \caption{Edge Inclusion Summary of Kruskal}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%% GATE CSE Kruskal Queston %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection{GATE CSE 2006}
Consider the following graph:

\input{2006_krus.tikz}
